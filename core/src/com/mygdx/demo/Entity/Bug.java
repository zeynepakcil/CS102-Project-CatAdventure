...
public class Bug extends Enemy {
    ...
    protected void defineEnemy() {
        ...
        vertices[0] = new Vector2(-5, 10).scl(1 / TuruncsAdventure.PPM);
        vertices[1] = new Vector2(5, 10).scl(1 / TuruncsAdventure.PPM);
        vertices[2] = new Vector2(-3, 9).scl(1 / TuruncsAdventure.PPM);
        vertices[3] = new Vector2(3, 9).scl(1 / TuruncsAdventure.PPM);
